...
```
Shard 01 ClickHouse кластера расположен на нодах ch1 и ch2, между ними используется репликация. 
Shard 02 расположен на нодах ch3 и ch4, между ними используется репликация.
...
по одному шарду на каждом сервере, с учетом этого установила ресурсы для серверов: нода PostgreSQL HA кластера имеет вдвое больше ресурсов cpu и memory.
